<?php
    ...
    Redux::setSection( $opt_name, array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'type'      => 'checkbox',
          'title'     => __( 'Enbale Listing To Marker Sync', 'tt' ),
          'subtitle'  => __( 'Applied on vertical map template', 'tt' ),
          'desc'      => __( 'Check this box, if you want to change icon on mouseover for vertical template search.', 'tt' ),
          'default'   => 0
        ),
      	array(
          'id'        => 'map-alternate-marker-property',
          'type'      => 'media',
          'title'     => __( 'Custom Map Marker: Listing To Map Sync', 'tt' ),
          'compiler'  => 'true',
          'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
          //'desc'      => __( '', 'tt' ),
          'subtitle'  => __( 'Transparent PNG file (Recommended Dimension: 100x138)', 'tt' ),
	...
	$default_taxonomies = array(
		__( 'Default Taxonomies', 'tt' ) => array(
    ...
    require_once ( TT_LIB . '/advanced-custom-fields.php' );
      ...
      'fields'    => array(
		...
		array(
          ...
          'id'        => 'property-listing-show-status-type',
          'type'      => 'checkbox',
          'title'     => __( 'Show Status/Type Above Excerpt', 'tt' ),
          'subtitle'  => __( 'When mouseover property listing, status and type will be shown above excerpt.', 'tt' ),
          //'desc'      => __( '', 'tt' ),
          'default'   => 1
        ),
		array(
          ...
          'type'      => 'media',
          'title'     => __( 'Sample Image For Listings', 'tt' ),
          'compiler'  => 'true',
          'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
          'desc'      => __( 'Image will be displayed in property listings only if featured image is not provided for property. Upload any custom image of appropriate size, preffered thumbnail-400-300.', 'tt' ),
          //'subtitle'  => __( '', 'tt' ),
        ),
				array(
		...
		array(
          'id'			=> 'property-page-gallery-header',
          'type'		=> 'radio',
          'title'       => __( 'Property Meta Image Gallery', 'tt' ),
          'subtitle'  	=> __( 'Applied on single property page gallery header', 'tt' ),
          //'desc'      => __( '', 'tt' ),                  
          'options'     => array(
            'default'   => __( 'Default', 'tt' ), 
            'custom'    => __( 'Custom', 'tt' ), 
		...
		array(
          'id'        => 'property-fields-selection-gallery-header',
          'type'      => 'repeater',
		  'width'     => '40%',
		  'limit'     => 4,
          'title'     => __( 'Property Meta Fields Gallery Header', 'tt' ),
          'subtitle'  => __( 'Applied on single property page gallery header', 'tt' ),
          'desc'      => __( 'You can select maximum 4 fields to show over gallery header from default property fields.', 'tt' ),
		  'required'  => array('property-page-gallery-header','=','custom'),
		  'fields'    => array(
		  		
				array(
				  'id'			=> 'selected-property-meta-fields-header',
				  'type'		=> 'select',
				  'options'		=> array_merge($default_taxonomies,  $default_fields_listing , array( 'estate_property_price' =>__( 'Price', 'tt' ))),
		...
		array(
          ...
          'multi'			=> true,
          'sortable'	=> false,
          'title'     => __( 'Hide Selected Additional Fields', 'tt' ),
          'subtitle'  => __( 'Applied on single property page', 'tt' ),
          'desc'      => __( 'Select all additional fields you want to hide in additional fields area on single property page.', 'tt' )
        ),
        array(
		...
		array(
          ...
          'type'      => 'checkbox',
          'title'     => __( 'Show Map On Property Page', 'tt' ),
          'subtitle'  => __( 'Applied on single property page only.', 'tt' ),
          //'desc'      => __( '', 'tt' ),
          'default'   => 1
        ),
        array(
        ...
        array(
          ...
          'type'      => 'text',
          'title'     => __( 'Default Contact Email ID', 'tt' ),
          //'subtitle'  => __( '', 'tt' ),
          ...
          'type'      => 'text',
          'title'     => __( 'CC To Admin Email ID', 'tt' ),
          //'subtitle'  => __( '', 'tt' ),
