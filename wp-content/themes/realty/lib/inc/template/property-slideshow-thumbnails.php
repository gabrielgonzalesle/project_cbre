<?php
if ( $property_images || ( $property_video_provider && $property_video_id && has_post_thumbnail() && $property_video_location == 'above' ) ) {
	...
	if ( $property_video_provider != 'none' && $property_video_id ) {
		...
		if ( ( $property_image_location == 'above' && $property_video_location == 'above' ) || ( $property_image_location == 'begin' && $property_video_location == 'begin' ) ) {
			if ( $property_video_provider == 'youtube' ) {
				...
				$video_thumbnail_output .= '<a href="#"><img src="' . get_template_directory_uri()  . '/lib/images/placeholder-600x300.png" /></a>';
			...
			if ( $property_video_provider == 'vimeo' ) {
				...
				$video_thumbnail_output  = '<div class="property-video-thumbnail" style="background-image:url(' . tt_get_vimeo_thumb( $property_video_id ) . ')" /><a href="#">';
