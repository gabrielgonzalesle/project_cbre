						...
						},
						{
							...
							onclick: function() {
								editor.windowManager.open( {
									...
									onsubmit: function( e ) {
										editor.insertContent( '[testimonials_vertical order="' + e.data.order_testimonials + '" count="' + e.data.count_testimonials + '"]');
									}
								});
							}
						},
						...
						},
						{
							...
							onclick: function() {
								editor.windowManager.open( {
									...
									onsubmit: function( e ) {
										editor.insertContent( '[featured_properties columns="' + e.data.columns_featured + '" style="' + e.data.featured_style + '" location="' + e.data.featured_location + '" status="' + e.data.featured_status + '" type="' + e.data.featured_type + '" features="' + e.data.featured_features + '" order="' + e.data.featured_order + '" num_of_listings="' + e.data.num_listings + '"]');
									}
								});
							}
						},
								...
								editor.windowManager.open( {
									...
									body: [
										...
										},
										{
											...
											minWidth: 300,
											'values': [
												{text: 'Grid', value: 'grid-view'},
												{text: 'List', value: 'list-view'},
									...
									onsubmit: function( e ) {
										...
										if (typeof e.data.view_listings != 'undefined' && e.data.view_listings.length)
											shortcode_str += ' view="' + e.data.view_listings + '"';
