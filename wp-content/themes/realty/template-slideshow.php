	...
	if ( $slideshow_type == "slideshow-type-custom" ) {
		...
		if ( have_rows('slideshow_custom_slides') ) :
			...
			while ( have_rows('slideshow_custom_slides') ) : the_row();
				...
				<?php if ( $slide_link ) { echo '<a href="' . $slide_link . '" class="slideshow-content-link" data="">'; } ?>
...
<!-- Nosotros -->
	<?php 
		$nosotros_image_id = get_post_meta( $post->ID, 'image', true ); 
		$nosotros_image_url= wp_get_attachment_image_src($nosotros_image_id, 'full');
		$quienes_somos = get_post_meta( $post->ID, 'quienes_somos', true );
		$valores = get_post_meta( $post->ID, 'valores', true );
	?>
	<div class="nosotros_home container-outside white-container">
		<div class="container">
			<div class="row">
				<h2 class="title">Nosotros</h2>
				<div class="col-sm-4">
					<img src="<?php echo $nosotros_image_url[0] ?>">
				</div>
				<div class="col-sm-4"><?php echo $quienes_somos?></div>
				<div class="col-sm-4"><?php echo $valores ?></div>
			</div>
		</div>
	</div>
<!-- fin nosotros -->
<!-- SERVICIOS -->
	<div class="servicios_home container-outside">
		<div class="container">
			<div class="row">
				<h2 class="title">Servicios</h2>
				<!-- <img id="mapServicios" usemap="#mapServicios" src="<?php echo get_site_url(); ?>/wp-content/images/servicios/circulo.png"> -->
				<img src="<?php echo get_site_url(); ?>/wp-content/images/servicios/circulo.png">
			</div>
		</div>
	</div>
<!-- FIN SERVICIOS -->
<!-- Reportes -->
	<div class="reportes container-outside white-container">
		<div class="container">
				<h2 class="title">Reportes de Mercadeo</h2>
				<?php
					$args = array('post_type' => "reporte",'order' => 'asc');
...
<!-- fin reportes -->
<!-- premios -->
	<div class="premios_title container-outside white-container">
		<div class="container">
			<h2 class="title">Premios y Reconocimientos</h2>
		</div>
	</div>
	<div class="premios_home container-outside">
		<div class="container">
			<div class="row premios-home">
...
<map name="mapServicios">
    ...
    <area alt="" title="" href="http://cbre.app/servicios/?item=7" color="7" shape="poly" coords="497,459,496,459,374,389,384,339,520,313,524,377" />
